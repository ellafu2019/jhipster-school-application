package com.schoolbaby.app.web.rest;

import com.schoolbaby.app.SchoolBabyApp;
...
@SpringBootTest(classes = SchoolBabyApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class SchoolBabyKafkaResourceIT {
    ...
    @Autowired
    private SchoolBabyKafkaProducer producer;

    @Autowired
    private SchoolBabyKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        SchoolBabyKafkaResource kafkaResource = new SchoolBabyKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/school-baby-kafka/publish?message=test"))
